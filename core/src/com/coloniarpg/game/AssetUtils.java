...
public class AssetUtils {
    ...
    public static Texture levelButton3;  // Definição da variável levelButton3
    ...
    private static void loadAssets() {
        ...
        levelButton3 = new Texture("level_button_3.png");  // Correção aqui
    ...
    public static void dispose() {
        ...
        levelButton3.dispose();  // Dispose da textura levelButton3
